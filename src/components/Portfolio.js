        ...
        <div className="Portfolio" id="Portfolio">
            ...
            <div className="portfolioProject">
                <div className="projectText">
                    ...
                    <p className="projectText-body">I have work as general manager and in product, UX/UI, and front development. We are currently very close to lauching a beta version which was made with React, Express and MongoDB. With ITTI we won the popular category award in the Innovation Week of the Universidad de los Andes, we were also 6th a the rector's challenge, InnoTIC100M, competing for 30,000 dollars. We are currently participating in the START Fellowship acceleration program.</p>
                </div>
